...
-- 8. Fix existing database function security (set immutable search_path)
DROP FUNCTION IF EXISTS public.update_ingredient_amount(text, numeric);
...
-- 9. Fix update_updated_at_column function security
